...
class MultiResUnet(torch.nn.Module):
	...
	'''
	def __init__(self, in_channels, out_channels, alpha=1.67, **kwargs):
		super().__init__()
		...
		self.conv_final = Conv2d_batchnorm(self.in_filters9, out_channels, kernel_size = (1,1), activation='None')
