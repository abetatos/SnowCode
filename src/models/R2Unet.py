...
class R2U_Net(nn.Module):
	...
	'''
    def __init__(self,in_channels=3, out_channels=1, t=2, **kwargs):
...
class RecU_Net(nn.Module):
    ...
    def __init__(self,in_channels=3,out_channels=1,t=2, **kwargs):
        ...
        self.RCNN1 = RCNN_block(ch_in=in_channels,ch_out=64,t=t)
...
class ResU_Net(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=1, **kwargs):
        ...
        self.ResCNN1 = ResCNN_block(ch_in=in_channels,ch_out=64)
