...
class NestNet(nn.Module):
    def __init__(self, in_channels, out_channels, deep_supervision=False, **kwargs):
        ...
        # 1x1 conv layer
        self.final_1x1_x01 = Final1x1ConvLayer(in_channels=filters[0], out_channels=out_channels)
        self.final_1x1_x02 = Final1x1ConvLayer(in_channels=filters[0], out_channels=out_channels)
        self.final_1x1_x03 = Final1x1ConvLayer(in_channels=filters[0], out_channels=out_channels)
        self.final_1x1_x04 = Final1x1ConvLayer(in_channels=filters[0], out_channels=out_channels)
